...
class laporanAktivitasBulanan extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('FullDashboard.bop.LaporanAktivitasBulanan.LaporanAktivitasBulanan', compact('bop', 'biayaUmum', 'biayaSaprasBop', 'totalpengajuan', 'totalRealisasi', 'search'));
    }

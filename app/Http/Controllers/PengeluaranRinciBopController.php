...
class PengeluaranRinciBopController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('FullDashboard.rinciBop.pengeluaranRinciBop.pengeluaranRinciBop', compact('bop', 'biayaUmum', 'biayaSaprasBop', 'totalpengajuan', 'totalsisa', 'totalrealisasi', 'search'));
    }
}

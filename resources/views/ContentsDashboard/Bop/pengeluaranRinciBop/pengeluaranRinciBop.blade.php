        ...
        <div class="content-header">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    {{-- BREADCUMB DI BAWAH --}}
                    <div class="col-sm-6">
                        <h1 class="m-0">Realisasi Rinci BOP</h1>
                        <ol class="breadcrumb ">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active"><a href="">Realisasi Rinci BOP</a></li>
                        </ol>
                    </div>
                    {{-- BREADCUMB DI BAWAH --}}
                </div>
                ...
                <div class="card card-orange">
                    <div class="card-header">
                        <h3 class="card-title" style="color: white; font-weight: 600">
                            Halaman Utama Realisasi Rinci Biaya Operasional
                        </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <div class="small-box bg-orange">
                                            ...
                                            {{-- <a href="{{ url('biayaKepegawaianRinci') }}" class="small-box-footer" style="color: white !important; ">Lihat
                                    ...
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <div class="small-box bg-warning">
                                            <div class="inner">
                                                ...
                                                <h4 style="color: white !important; font-weight: 700">Rp.
                                                    {{ number_format($totalrealisasi, 0, ',', '.') }}</h4>
                                            </div>
                                            <div class="icon">
                                                <i class="ion ion-person-add"></i>
                                            </div>
                                            {{-- <a href="{{ url('payrollpegawai') }}" style="color: white !important; " class="small-box-footer">Lihat Detail
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <!-- small box -->
                                        <div class="small-box bg-success" style="width: 333px">
                                            <div class="inner">
                                                <span style="color: white !important; font-weight: 700"> Jumlah Sisa:
                                                    <small style="color: white !important; font-weight: 800">(Jumlah
                                                        Pengajuan - Jumlah Realisasi)</small> </span>
                                                <p></p>
                                                <h4 style="color: white !important; font-weight: 700">Rp.
                                                    {{ number_format($totalsisa, 0, ',', '.') }}</h4>
                                            </div>
                                            <div class="icon">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Tabel Pemasukan Dan Pengeluaran Realisasi Biaya
                                                    Operasional</h3>
                                                ...
                                                <table class="table table-head-fixed table-hover text-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="font-weight: 600">PEMASUKAN</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                            ...
                                                            @if (auth()->user()->level === 'Admin')
                                                                <td>
                                                                    <a href="{{ route('biayaKepegawaian.create') }}"
                                                                        ...
                                                                        style="text-align: center !important; margin-left: 20px !important">
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if (auth()->user()->level === 'Admin')
                                                                    <td style="text-align: center !important">
                                                                        ...
                                                                        {{-- <a href="{{ route('biayaKepegawaian.create') }}" class="button-31" style="color: white !important">
                                ...
                                @endif --}}
                                                        ...
                                                        @foreach ($bop as $index => $user)
                                                            <tr>
                                                                ...
                                                                @if (auth()->user()->level === 'Admin')
                                                                    <td style="text-align: center !important">
                                                                        <a href="{{ route('biayaRinciKepegawaian.edit', $user->id) }}"
                                                                            class="button-33 btn-sm" role="button">
                                                                            <i class="fas fa-pencil-alt"></i>
                                                                        </a>
                                                                        {{-- <a href="{{ route('biayaRinciKepegawaian.create') }}" class="button-31" style="color: white !important">
                                                                      <i class="fas fa-plus"></i>
                                                                  </a> --}}
                                                                        <form method="POST"
                                                                            action="{{ route('biayaRinciKepegawaian.destroy', $user->id) }}"
                                                                            style="display: inline-block">
                                                                            @csrf
                                                                            <input name="_method" type="hidden"
                                                                                value="DELETE">
                                                    ...
                                                    $user->unsurbiaya,
                                                                ...
                                                                @if (auth()->user()->level === 'Admin')
                                                                    <td style="text-align: center !important">
                                                                        <a href="{{ route('rinciBiayaUmumBop.edit', $user->id) }}"
                                                                            class="button-33 btn-sm" role="button"><i
                                                                                class="fas fa-pencil-alt"></i></a>

                                                                        {{-- <a href="javascript:void(0)" id="show-bop"
                                                data-url="{{ route('rinciBiayaUmumBop.show', $user->id) }}"
                                                class="button-31" style="color: white !important"><i
                                                    class="fas fa-eye"></i></a> --}}


                                                                        {{-- <a href="{{ route('rinciBiayaUmumBop.create') }}"
                                                        class="button-31" style="color: white !important"><i
                                                            class="fas fa-plus"></i></a> --}}

                                                                        <form method="POST"
                                                                            action="{{ route('rinciBiayaUmumBop.destroy', $user->id) }}"
                                                                            style="display: inline-block">
                                                                            @csrf
                                                                            <input name="_method" type="hidden"
                                                                                value="DELETE">
                                ...
                                @endif --}}
                                                        ...
                                                        @foreach ($biayaSaprasBop as $index => $user)
                                                            <tr>
                                                                ...
                                                                <td>Rp. {{ number_format($user->sisa, 0, ',', '.') }}
                                                                </td>
                                                                <td>{!! str_ireplace(
                                                                    $search,
                                                                    '<strong style="color: black; font-weight: bold;">' . $search . '</strong>',
                                                                ...
                                                                @if (auth()->user()->level === 'Admin')
                                                                    <td style="text-align: center !important">
                                                                        <a href="{{ route('biayaRinciSapras.edit', $user->id) }}"
                                                                            class="button-33 btn-sm" role="button"><i
                                                                                class="fas fa-pencil-alt"></i></a>
                                                            ...
                                                            class="button-31" style="color: white !important"><i
                                                                class="fas fa-eye"></i></a> --}}
                                                                        ...
                                                                        {{-- <a href="{{ route('biayaRinciSapras.create') }}"
                                                            class="button-31" style="color: white !important"><i
                                                                class="fas fa-plus"></i></a> --}}

                                                                        <form method="POST"
                                                                            action="{{ route('biayaRinciSapras.destroy', $user->id) }}"
                                                                            style="display: inline-block">
                                                                            @csrf
                                                                            <input name="_method" type="hidden"
                                                                                value="DELETE">
                                                        ...
                                                        <tr>
                                                            <td colspan="3" class="text-bold"
                                                                style="text-align: center !important"> Total:</td>
                                                            <td colspan="">
                                                                <b>Rp.

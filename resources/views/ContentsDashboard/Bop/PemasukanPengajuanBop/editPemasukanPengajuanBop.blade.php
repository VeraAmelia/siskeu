                    ...
                    <div class="card card-orange">
                        ...
                        <div class="card-body">
                            <div class="row">
                                {{-- KONTEN KIRI --}}
                                <div class="col-md-6">
                                    <form action="{{ route('biayaKepegawaianBop.update', $bop->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="unsurbiaya" class="form-control"
                                                    id="unsurbiaya" autocomplete="off" placeholder="Masukan Unsur Biaya"  value="{{ $bop->unsurbiaya }}">
                                            </div>
                                        </div> --}}
                                        ...
                                        {{-- <div class="form-group" id="dropdownOptions" style="display: none;">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="detailbiaya">
                                                <option value="- kursi" {{ $bop->detailbiaya == '- kursi' ? 'selected' : '' }}>- kursi</option>
                                                <option value="- meja" {{ $bop->detailbiaya == '- meja' ? 'selected' : '' }}>- meja</option>
                                            </select>
                                        </div> --}}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="pengajuan" class="form-control format-rupiah" id="pengajuan"
                                                placeholder="Masukan Pengajuan" autocomplete="off"  value="{{ number_format($bop->pengajuan, 0, ',', '.') }}">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('biayaKepegawaianBop.index') }}" class="button-31" style="color: white !important">Kembali</a>
                            </div>
                            </form>

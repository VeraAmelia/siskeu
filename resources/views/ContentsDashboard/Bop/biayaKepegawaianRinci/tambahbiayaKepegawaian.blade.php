            ...
            <div class="card card-orange">
                ...
                <div class="card-body">
                    <div class="row">
                        {{-- KONTEN KIRI --}}
                        <div class="col-md-6">
                            <form action="{{ route('biayaRinciKepegawaian.store') }}" method="POST">
                                {{-- @csrf --}}
                                {{ csrf_field() }}
                                <!-- IP mask -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="txt1" oninput="calculate()" type="text" name="pengajuan" class="form-control format-rupiah"
                                        id="pengajuan" autocomplete="off" placeholder="Masukan Jumlah Usulan" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="txt2" oninput="calculate()" type="text" name="realisasi" class="form-control format-rupiah"
                                        id="realisasi" autocomplete="off" placeholder="Masukan Jumlah Realisasi" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sisa" autocomplete="off" class="form-control format-rupiah" id="txt3"
                                        placeholder="Pengurangan Otomatis" readonly>
                                </div>
                            </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <a href="{{ route('laporanRinciBop.index') }}" class="button-31"

                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb ">
                            ...
                            <li class="breadcrumb-item active"><a href="">Sarana Prasarana</a></li>
                        </ol>
                    </div>
                    {{-- BREADCUMB DI BAWAH --}}
                </div>
                ...
                <div class="card card-orange">
                    <div class="card-header">
                        <h3 class="card-title" style="color: white; font-weight: 600">
                            Halaman Utama Biaya Sarana Prasarana (BOP) Biaya Operasional
                        </h3>
                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-6">
                                        <div class="small-box bg-orange">
                                            ...
                                            <a href="{{ url('saPrasaranaBop') }}" class="small-box-footer">Lihat Detail
                        ...
                        <div class="card card-orange card-outline">
                            <div class="card-tools d-flex justify-content-between">
                                ...
                                <a href="{{ route('saPrasaranaBop.create') }}" class="button-85 ml-2"
                            ...
                            <div class="card-body">
                                <div class="card-body table-responsive p-0">
                                    <div class="card-tools d-flex justify-content-between">
                                        <div class="d-flex">
                                            <label for="paginationSelect" class="mr-2 hide-select">Tampilkan:</label>
                                    ...
                                    <div class="card-tools d-flex justify-content-between">
                                        <div class="d-flex ml-auto">
                                            <div class="search-input-group input-group input-group-lg"
                                                ...
                                                <form method="get" action="/saPrasaranaBop" style="display: flex;">
                                    ...
                                    <table class="table table-hover table-head-fixed text-center">
                                        ...
                                        <tbody>
                                            @if ($bop->isEmpty())
                                                <tr>
                                                    <td colspan="6" class="text-center">Tidak ada data di database
                                                    </td>
                                                </tr>
                                            @else
                                                @php
                                                ...
                                                @foreach ($bop as $index => $user)
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($user->pengajuan, 0, ',', '.') }}</td>
                                                        <td>

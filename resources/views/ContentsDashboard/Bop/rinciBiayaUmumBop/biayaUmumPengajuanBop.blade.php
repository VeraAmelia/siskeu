        ...
        <div class="content-header">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    {{-- BREADCUMB DI BAWAH --}}
                    <div class="col-sm-6">
                        <h1 class="m-0">Biaya Umum</h1>
                        <ol class="breadcrumb ">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active"><a href="">Biaya Umum</a></li>
                        </ol>
                    </div>
                    {{-- BREADCUMB DI BAWAH --}}
                </div>
                ...
                <div class="card card-orange">
                    <div class="card-header">
                        <h3 class="card-title" style="color: white; font-weight: 600">
                            Halaman Utama Biaya Umum (BOP) Biaya Operasional
                        </h3>
                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-6">
                                        <div class="small-box bg-orange">
                                            ...
                                            <a href="{{ url('biayaUmumPengajuanBop') }}" class="small-box-footer">Lihat
                        ...
                        <div class="card card-orange card-outline">
                            <div class="card-tools d-flex justify-content-between">
                                ...
                                <a href="{{ route('biayaUmumPengajuanBop.create') }}" class="button-85 ml-2"
                                    ...
                                    <div class="card-tools d-flex justify-content-between">
                                        <div class="d-flex ml-auto">
                                            <div class="search-input-group input-group input-group-lg"
                                                ...
                                                <form method="get" action="/biayaUmumPengajuanBop"
                                                    style="display: flex;">

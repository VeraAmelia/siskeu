                    ...
                    <div class="card card-orange">
                        <div class="card-header">
                            <h3 class="card-title" style="color: white; font-weight: 600"><i
                                    class="fas fa-plus-circle"></i> Halaman Tambah Laporan Rinci Pemasukan BOP
                            </h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                {{-- KONTEN KIRI --}}
                                <div class="col-md-6">
                                    <form action="{{ route('pemasukanbop.store') }}" method="POST">
                                        {{-- @csrf --}}
                                        {{ csrf_field() }}
                                        <!-- IP mask -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="txt1" oninput="calculate()" type="text" name="jumlahusulan" class="form-control format-rupiah"
                                                    id="jumlahusulan" autocomplete="off" placeholder="Masukan Jumlah Usulan" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="txt2" oninput="calculate()" type="text" name="jumlahrealisasi" class="form-control format-rupiah"
                                                    id="jumlahrealisasi" autocomplete="off" placeholder="Masukan Jumlah Realisasi" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="petugas" class="form-control" id="petugas"
                                                placeholder="Masukan Petugas"  autocomplete="off">
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer" style="margin-top: -25px">
                            Halaman <a href="#">Tambah Laporan Rinci Pemasukan BOP</a> Lembaga STMIK Mardira Indonesia.

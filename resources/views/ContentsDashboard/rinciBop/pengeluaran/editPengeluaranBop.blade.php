                    ...
                    <div class="card card-orange">
                        <div class="card-header">
                            <h3 class="card-title" style="color: white; font-weight: 600"><i
                                    class="fas fa-plus-circle"></i> Halaman Edit Rinci Laporan Pengeluaran BOP
                            </h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                {{-- KONTEN KIRI --}}
                                <div class="col-md-6">
                                    <form action="{{ route('pengeluaranbop.update', $bop->id) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="txt1" oninput="calculate()" type="text" name="jumlahusulan" class="form-control format-rupiah"
                                                    id="jumlahusulan" autocomplete="off" value="{{ number_format($bop->jumlahusulan, 0, ',', '.') }}" placeholder="Masukan Unsur Biaya" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="txt2" oninput="calculate()" type="text" name="jumlahrealisasi" class="form-control format-rupiah"
                                                    id="jumlahrealisasi" autocomplete="off" value="{{ number_format($bop->jumlahrealisasi, 0, ',', '.') }}" placeholder="Masukan Unsur Biaya" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="petugas" class="form-control" id="petugas"
                                                placeholder="Masukan Pengajuan"  value="{{ $bop->petugas }}" autocomplete="off">
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer" style="margin-top: -25px">
                            Halaman <a href="#">Edit Rinci Laporan Pengeluaran BOP</a> Lembaga STMIK Mardira Indonesia.

                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-6">
                                        <div class="small-box bg-orange">
                                            ...
                                            <a href="{{ url('biayaKepegawaianRinci') }}" class="small-box-footer">Lihat
                        ...
                        <div class="card card-orange card-outline">
                            <div class="card-tools d-flex justify-content-between">
                                ...
                                {{-- <a href="{{ route('biayaKepegawaian.create') }}" class="button-85 ml-2"
                                                            ...
                                                            @foreach ($bop as $index => $user)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center !important">
                                                                        <a href="{{ route('biayaKepegawaianRinci.edit', $user->id) }}"
                                                                            class="button-33" role="button">
                                                                            <i class="fas fa-pencil-alt"></i>
                                                                        </a>
                                                                        {{-- <a href="{{ route('biayaKepegawaianRinci.create') }}" class="button-31" style="color: white !important">
                                                                      <i class="fas fa-plus"></i>
                                                                  </a> --}}
                                                                        <form method="POST"
                                                                            action="{{ route('biayaKepegawaianRinci.destroy', $user->id) }}"
                                ...
                                @endif --}}
                                                            ...
                                                            @foreach ($saPrasaranaBop as $index => $user)
                                                                <tr>
                                                                    ...
                                                                    <td>Rp. {{ number_format($user->realisasi, 0, ',', '.') }}</td>
                                                                        <td>Rp. {{ number_format($user->sisa, 0, ',', '.') }}</td>
                                                                    <td>{!! str_ireplace(
                                                                        $search,
                                                                        '<strong style="color: black; font-weight: bold;">' . $search . '</strong>',
                                                                        $user->keterangan,

...
<body>
        ...
        <tr>
            ...
            <td class="tengah small-text text-bold" style="width: 190%;">
                <div class="center-text text-bold">
                    <h2 class="small-text text-bold">PEMERINTAH DAERAH PROVINSI JAWA BARAT</h2>
                    <h2 class="small-text text-bold">LEMBAGA PERGURUAN TINGGI</h2>
                    <h2 class="small-text text-bold">STMIK MARDIRA INDONESIA</h2>
                    <p class="small-text text-bold">Alamat : Jl. Soekarno-Hatta No. 211 Leuwipanjang, Situsaeur, Kec. Bojongloa
    ...
    <div class="table-header" style="display: flex; align-items: center;">
        <h5 class="small-text"><span class="text-bold">Lampiran:</span> <span style="font-weight: normal;">Laporan Semua Pengajuan BOP</span></h5>
        <h5 class="small-text"><span class="text-bold">Periode:</span> <span style="font-weight: normal;"> {{ date('d-m-Y') }}</span></h5>
        <h5 class="small-text"><span class="text-bold">Yang Melaporkan:</span> <span style="font-weight: normal;">Admin Lembaga STMIK
                Mardira Indonesia</span></h5>
    </div>
